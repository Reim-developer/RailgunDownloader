...
def download(saveDir: str, webURL: str) -> None:
    print(f"[INFO] Download doujinshi from {webURL}", flush = True)
    try:
...
with ThreadPoolExecutor(max_workers = 50) as executor:
    executor.submit(download, argument_value.d, argument_value.u)